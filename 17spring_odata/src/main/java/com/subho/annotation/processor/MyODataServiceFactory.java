...
import com.subho.annotation.processor.MyODataProcessor;
import com.subho.BuilderODataServlet;
import com.subho.annotation.processor.MyODataAnnotationDs;
...
public class MyODataServiceFactory extends ODataServiceFactory {
	private static final org.slf4j.Logger log = LoggerFactory.getLogger(MyODataServiceFactory.class);
