package com.subho.configuration;
...
/**
 * This class uses the database connection information provided in the
 * environment variable VCAP_SERVICES to connect to the database, initializes
 * JPA, and creates a CRUD repository instance. This is done in three steps, as
 * explained below.
 * <p>
 * As this class is registered in the Spring application context
 * ({@link com.sap.bulletinboard.ads.ContextListener)), the three methods
 * annotated with {@literal @}Bean also are registered and used to provide bean
 * instances of {@link DataSource}, {@link EntityManagerFactory}, and
 * {@link JpaTransactionManager}, respectively.
 * <p>
 * (Step 3) The @EnableJpaRepositories annotation (of Spring Data JPA) is used
 * to provide a convenient repository, based on JPA (EntityManager,
 * TransactionManager).
 */
@Configuration
